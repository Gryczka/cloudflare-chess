/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 21431e49dc59f3e998265ed7da1919e5)
// Runtime types generated with workerd@1.20260511.1 2026-05-14 global_fetch_strictly_public
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ChessMatch" | "Matchmaker" | "GameLobby";
	}
	interface Env {
		KV: KVNamespace;
		R2_ARCHIVE: R2Bucket;
		DB: D1Database;
		GAME_ANALYSIS_QUEUE: Queue;
		RATE_LIMIT_ENROLL: RateLimit;
		RATE_LIMIT_LOGIN: RateLimit;
		BROWSER: Fetcher;
		AI: Ai;
		ASSETS: Fetcher;
		TURNSTILE_SECRET_KEY: "";
		AUTH_SECRET: string;
		CHESS_MATCH: DurableObjectNamespace<import("./src/worker").ChessMatch>;
		MATCHMAKER: DurableObjectNamespace<import("./src/worker").Matchmaker>;
		GAME_LOBBY: DurableObjectNamespace<import("./src/worker").GameLobby>;
	}
}
